...
@bot.on(cok_cmd(outgoing=True, pattern=r"skip(?:\s|$)([\s\S]*)"))
...
@bot.on(cok_cmd(outgoing=True, pattern=r"volume(?: |$)(.*)"))
...
@bot.on(cok_cmd(outgoing=True, pattern="playlist$"))
...
CMD_HELP.update(
    {
        "cokvcgmusik": "**Plugin : **`cokvcgmusik`\
