...
CMD_HELP.update(
    {
        ...
        \n\n  •↳  **𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `.end`"
        \n  •↳ : **Untuk Memberhentikan lagu yang di putar di voice chat group"
        \n\n  •↳  **𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `.pause`"
        \n  •↳ : **Untuk memberhentikan lagu yang sedang diputar"
        \n\n  •↳  **𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `.resume`"
        \n  •↳ : **Untuk melanjutkan pemutaran lagu yang sedang diputar"
