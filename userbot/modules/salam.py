...
async def typewriter(typew):
    typew.pattern_match.group(1)
    await typew.edit("𝐎𝐏𝐄𝐍 𝐕𝐂𝐒 𝐑𝐄𝐀𝐋"
                     "\n\n"
                     "𝙏𝙖𝙡𝙡𝙚𝙣𝙩 : @KasihKecil"
                     "\n\n"
                     "\n30 𝙠 - 5 𝙢𝙚𝙣𝙞𝙩"
                     ...
                     "\n\n"
                     "\n150 𝙠 - 30 𝙢𝙚𝙣𝙞𝙩 ( 𝙎𝙇𝙊𝙒 )"
                     "\n250 𝙠 - 30 𝙢𝙚𝙣𝙞𝙩 ( 𝘽𝘼𝙍-𝘽𝘼𝙍 )"
                     "\n\n"
                     "𝙏𝙛 𝙫𝙞𝙖 𝘿𝙖𝙣𝙖 💰"
                     "\n- 𝙏𝙖𝙡𝙡𝙚𝙣𝙩 𝙂𝘾¹⁸⁺"
                     "\n- 𝙏𝙞𝙙𝙖𝙠 𝙥𝙪𝙣𝙮𝙖 𝙜𝙧𝙪𝙗 𝙩𝙚𝙨𝙩𝙞"
                     "\n- 𝙠𝙖𝙨𝙞𝙝 𝙘𝙪𝙢𝙖 𝙥𝙪𝙣𝙮𝙖 𝙨𝙖𝙩𝙪 𝙖𝙠𝙪𝙣 _𝙉𝙊 𝙁𝘼𝘾𝙀 _ 📍𝙮𝙖𝙣𝙜 𝙧𝙚𝙖𝙡 @KasihKecil 𝙮𝙖𝙣𝙜 𝙡𝙖𝙞𝙣 𝙗𝙪𝙠𝙖𝙣 𝙖𝙠𝙪 ."
                     "\n\n"
                     "𝐀𝐃𝐌𝐈𝐍 :"
