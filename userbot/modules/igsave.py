...
CMD_HELP.update({"igsave": "𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `.igsave`"
                 "\n↳ : Download Postingan di Instagram, Silahkan Salin Link Postingan Instagram Yang Ingin Anda Download Terus Kirim Link, Lalu Reply dan Ketik `.igsave`"})
