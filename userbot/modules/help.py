...
async def help(rambot):
    ...
    if args:
        ...
        await rambot.edit(f"**{REPO_NAME}**\n\n"
                         ...
                         f"{EMOJI_HELP} {string}\n\n**ㅤㅤ🔞Channel 1:** ㅤㅤ**🔞Channel 2:**\nㅤ[𓆩 ExPsychopat 𓆪](https://t.me/ExPsychopat)ㅤㅤ[𓆩 WXShoot 𓆪](https://t.me/WXShoot)\n**🔞Channel 3:ㅤㅤ [𓆩 𝅱༗ཹཹ͜͡MyTripFullSange 𓆪](https://t.me/MyTripFullSange)\n\nNGETIK COMMANDS/PERINTAH YANG BENER YA GOBLOK XD!!\n\n")
