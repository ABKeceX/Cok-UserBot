...
async def typewriter(typew):
    ...
    sleep(1.5)
    await typew.edit("**SAYA HARUS WASPADA TERHADAP**")
    sleep(1)
    await typew.edit("**WIBU~~**")
    sleep(1.5)
    await typew.edit("**ㅤW**")
    sleep(1)
    await typew.edit("**ㅤㅤI**")
    sleep(1)
    await typew.edit("**ㅤㅤㅤB**")
    sleep(1)
    await typew.edit("**ㅤㅤㅤㅤU**")
    sleep(2)
    await typew.edit("**SEKALI LAGII**")
    sleep(1)
    await typew.edit("**ㅤW**")
    sleep(1)
    await typew.edit("**ㅤㅤI**")
    ...
    await typew.edit("**ㅤㅤㅤㅤU**")
    sleep(1.5)
    await typew.edit("**LARIII ADA WIBU BAU BAWANG**")
    sleep(2)
    await typew.edit("**HENGKER TZY PROPELER ANTINOOB**")
    sleep(2)
    await typew.edit("**KU HARUS LARIII🏃‍♂️🏃‍♂️**")
    sleep(1)
    await typew.edit("                                    🏃‍♂️   (WIBU)")
    sleep(0.2)
    await typew.edit("                                   🏃‍♂️    (WIBU)")
    sleep(0.2)
    await typew.edit("                                  🏃‍♂️     (WIBU)")
    ...
    await typew.edit("🏃‍♂️                                       (WIBU)")
    sleep(2)
    await typew.edit("**Untung si wibu gak ngejar**")
    sleep(2)
# Create by Abe(@yangmutebabi)
...
async def typewriter(typew):
    typew.pattern_match.group(1)
    await typew.edit("**Wadow Wadowww**")
    sleep(2)
    await typew.edit("**Eummm...**")
    sleep(1.5)
    await typew.edit("**Ekhemmm**")
    sleep(1.5)
    await typew.edit("**Maen bot Mulu ya**")
    sleep(3)
    await typew.edit("**Baru pasang bot apa gimana?**")
    sleep(3)
    await typew.edit("**Alay tau gak Jiakhhh**")
# Create by Abe(@yangmutebabi)
