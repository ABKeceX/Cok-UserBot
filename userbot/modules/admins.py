...
CMD_HELP.update(
    {
        ...
        "\n\n𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `.cmute` <username/balas ke pesan> <alasan (optional)>"
        "\n↳ : Membisukan mereka."
        "\n\n𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `.uncmute` <username/reply>"
        "\n↳ : Reply ke pesan seseorang untuk `.uncmute` untuk melepas mereka dari cmute."
        "\n\n𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `.zombies`"
